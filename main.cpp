...
static const string mainnet_seeds[] = {"101.132.180.96", "101.132.125.68", "47.74.6.39", "47.100.55.227", "47.104.76.15", "120.55.52.22", "39.108.163.236", "47.91.209.188", "47.74.180.81", ""};
static const string testnet_seeds[] = {"47.104.76.15", "120.55.52.22", "39.108.163.236", ""};

static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("101.132.180.96", 8888), true);
  }
  do {
